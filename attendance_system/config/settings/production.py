"""
Production settings for AI-based Attendance System.
...
# Must set ALLOWED_HOSTS in production
...
# Media files - recommend cloud storage (AWS S3, Google Cloud Storage, etc.)
# Example for AWS S3:
...
# Configure channel layers (Redis recommended for production)
CHANNEL_LAYERS = {
    'default': {
